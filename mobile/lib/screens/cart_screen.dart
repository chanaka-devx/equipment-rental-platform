...
abstract class CartScreenState extends State<CartScreen> {
  Future<void> loadCart();
}

class _CartScreenState extends CartScreenState {
                            ...
                            child: Column(
                              ...
                              children: [
                                        ...
                                        if (dep > 0) {
                                          return Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: Text('+Rs.$dep dep.', style: const TextStyle(fontSize: 10, color: AppTheme.onSurfaceVariant)),
                                            ),
                                          );
                                        }
                                ...
                                Row(
                                  children: [
                                    IconButton(
                                      icon: const Icon(Icons.remove_circle_outline, color: AppTheme.brandOrange, size: 24),
                                    ...
                                    const SizedBox(width: 12),
                                    IconButton(
                                      icon: const Icon(Icons.add_circle_outline, color: AppTheme.brandOrange, size: 24),
                                      onPressed: () => _updateQuantity(item['equipmentId'], (item['quantity'] ?? 1) + 1),
                                      padding: EdgeInsets.zero,
                                      constraints: const BoxConstraints(),
                                    ),
